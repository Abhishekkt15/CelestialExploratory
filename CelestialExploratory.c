...
DrawTextXY(-1.75,2,1.0,0.0014,"CELESTIAL EXPLORATORY ");
glColor3f(1.0,0.0,0.0);
DrawTextXY(-3.25,1.5,0.0,0.001," SUBMITTED BY :- ");
glColor3f(0.0,0.0,1.0);
DrawTextXY(-2.5,1.2,0.0,0.001," B R NITHYASHREE ");
DrawTextXY(-2.5,0.95,0.0,0.001," ABHISHEK K T ");
glColor3f(0.0,0.0,1.0);
DrawTextXY(1.009,1.2,0.0,0.001,"1CG15CS011");
DrawTextXY(1.015,0.95,0.0,0.001,"1CG15CS001");
glColor3f(1.0,0.0,0.0);
DrawTextXY(-1.25,0,0.0,0.001," UNDER THE GUIDENCE OF : ");
//glColor3f(0.0,0.0,1.0);
glColor3f(1.0,0.0,0.2);
DrawTextXY(0.2,-.2,0.0,0.001,"DHARNESH KUMAR M L");                           //red
DrawTextXY(0.3,-.4,0.0,0.001," Assistant Prof.of CSE ");
DrawTextXY(0.3,-.6,0.0,0.001," CIT GUBBI");
...
DrawTextXY(-1.25,3.1,0.0,0.001," 1: Press B to overview the complete Celestial Exploratory ");
DrawTextXY(-1.25,2.9,0.0,0.001," 2: M to rotate the Planet Mercury around the Sun ");
DrawTextXY(-1.25,2.7,0.0,0.001," 3: m to rotate the Planet Mercury with in its Path ");
DrawTextXY(-1.25,2.5,0.0,0.001," 4: V or v to rotate the Planet Venus ");
DrawTextXY(-1.25,2.3,0.0,0.001," 5: E or e to rotate the Planet Earth ");
DrawTextXY(-1.25,2.1,0.0,0.001," 6: R or r to rotate the Planet Mars");
DrawTextXY(-1.25,1.9,0.0,0.001," 7: J or j to rotate the Planet Jupiter");
DrawTextXY(-1.25,1.7,0.0,0.001," 8: S or s to rotate the Planet Satrun");
DrawTextXY(-1.25,1.5,0.0,0.001," 9: U or u to rotate the Planet Uranus");
DrawTextXY(-1.25,1.3,0.0,0.001,"10: N or n to rotate the Planet Neptune");
